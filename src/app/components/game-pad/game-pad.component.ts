...
export class GamePadComponent implements OnInit, OnDestroy {
  ...
  playOptions: IconOption[] = [
    {
      text: GamePadKey.Pause,
      icon: GamePadIcon.Pause,
      func: this.toggleActive.bind(this)
    },
    {
      text: GamePadKey.Play,
      icon: GamePadIcon.Play,
      func: this.toggleActive.bind(this)
    }
  ]
  baseOptions: IconOption[] = [
    {
      text: GamePadKey.Hint,
      icon: GamePadIcon.Hint,
      func: this.handleHint.bind(this)
    },
    {
      text: GamePadKey.Undo,
      icon: GamePadIcon.Undo,
      func: this.handleUndo.bind(this)
    },
    {
      text: GamePadKey.Erase,
      icon: GamePadIcon.Erase,
      func: this.handleClear.bind(this)
    }
  ]
  ...
  getPlayOption(isActive: boolean): IconOption {
    return this.playOptions.find((opt) =>
      isActive ? opt.text === GamePadKey.Pause : opt.text === GamePadKey.Play
    ) as IconOption
  }
